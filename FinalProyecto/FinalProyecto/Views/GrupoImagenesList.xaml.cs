...
namespace FinalProyecto.Views
{
    ...
    public partial class GrupoImagenesList : ContentPage
    {
        ...
        protected async override void OnAppearing()
        {
            ...
            string url = string.Format("http://3.15.208.156/WSXamarin/files/getfiles/{0}/{1}", "Imagenes", App.Current.Properties["idGroup"]);
        ...
        private async void ListStudent_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            var detalles = new VerImagenGrupos(obj.fileName.ToString(), obj.filePath.ToString(), obj.idFile.ToString());
